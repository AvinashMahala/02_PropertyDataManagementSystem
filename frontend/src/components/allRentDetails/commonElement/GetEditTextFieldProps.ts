...
const getEditTextFieldProps = (
    cell: commonImports.MRT_Cell<AllRentDetailsModel.IRentDetailsViewModel>,
  ...
  options: UserModel.User[]
    ...
    commonImports.useCallback(
        (
            ...
            validationErrors: { [key: string]: string},
          options: UserModel.User[]
        ): commonImports.MRT_ColumnDef<AllRentDetailsModel.IRentDetailsViewModel>["muiTableBodyCellEditTextFieldProps"] => {
